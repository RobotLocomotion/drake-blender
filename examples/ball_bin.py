...
def main():
    ...
    parser.add_argument(
        "--color",
        action="store_true",
        help="If true, stores the color image. At least one of --color, "
        "--depth, or --label must be specified.",
    )
    parser.add_argument(
        "--depth",
        action="store_true",
        help="If true, stores the depth image. At least one of --color, "
        "--depth, or --label must be specified.",
    )
    parser.add_argument(
        "--label",
        action="store_true",
        help="If true, stores the label image. At least one of --color, "
        "--depth, or --label must be specified.",
    )
    ...
    if not (args.color or args.depth or args.label):
        print(
            "No image types have been specified; no outputs will be generated."
        )
        return
